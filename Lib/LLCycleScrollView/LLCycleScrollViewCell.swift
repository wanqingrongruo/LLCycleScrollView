...
class LLCycleScrollViewCell: UICollectionViewCell {
    ...
    override func layoutSubviews() {
        ...
        titleBackView.frame = CGRect.init(x: 0, y: frameH - titleLabelHeight, width: frameW, height: titleLabelHeight)
        titleLabel.frame = CGRect.init(x: titleLabelLeading, y: 0, width: frameW - titleLabelLeading - 5, height: titleLabelHeight)
    }
}
